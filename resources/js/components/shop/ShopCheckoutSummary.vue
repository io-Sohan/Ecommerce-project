...
const grandTotal = computed(() => subtotal - discountAmount + deliveryCharge);
        ...
        >
            ...
            <div class="border-t border-gray-100 px-5 py-4">
                ...
                <div v-if="!couponValid" class="flex gap-2">
                    ...
                    <button
                        type="button"
                        class="shrink-0 rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-gray-800 disabled:opacity-50"
                        :disabled="!couponInput.trim() || couponApplying"
                        @click="emit('applyCoupon', couponInput)"
                    >
                ...
                <p
                    v-if="couponMessage && !couponValid"
