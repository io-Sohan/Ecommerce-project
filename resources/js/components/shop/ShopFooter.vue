        ...
        <div class="mx-auto max-w-7xl px-4 py-14 sm:px-6 md:py-20 lg:px-8">
                ...
                <div>
                    ...
                    <div class="mt-5 flex gap-3">
                        <a
                            href="#"
                            aria-label="Facebook"
                            class="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 text-gray-400 transition duration-200 hover:bg-shop-primary-600 hover:text-white hover:shadow-lg hover:shadow-shop-primary-600/25"
                        >
                            <svg
                                class="h-4 w-4"
                                fill="currentColor"
                        ...
                        <a
                            href="#"
                            aria-label="YouTube"
                            class="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 text-gray-400 transition duration-200 hover:bg-red-600 hover:text-white hover:shadow-lg"
                        >
                            <svg
                                class="h-4 w-4"
                                fill="currentColor"
                ...
                <div>
                    ...
                    <ul class="mt-5 space-y-3 text-sm">
                        <li>
                            <Link
                                :href="home()"
                                class="text-gray-400 transition duration-200 hover:text-shop-primary-500"
                                >Home</Link
                            >
                        </li>
                        <li>
            ...
            >
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span
                        class="rounded-lg bg-white/5 px-3 py-1.5 text-xs font-medium text-gray-300 ring-1 ring-white/10"
