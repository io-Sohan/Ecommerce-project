    ...
    >
        <div class="relative aspect-square overflow-hidden bg-gray-50">
            ...
            <button
                ...
                class="absolute top-3 right-3 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-white/95 text-red-500 shadow-lg transition duration-200 hover:scale-110 hover:bg-white focus:ring-2 focus:ring-shop-primary-600 focus:outline-none active:scale-95"
        ...
        <div class="flex flex-1 flex-col p-4">
            ...
            <div class="mt-2 flex items-center gap-2">
                <span class="text-lg font-bold text-shop-primary-600">{{
