...
test('admins can view products with a soft deleted category', function () {
    $admin = User::factory()->admin()->create();
    $category = Category::factory()->create(['name' => 'Archived Category']);
    $product = Product::factory()->for($category)->create();
    $category->delete();
    ...
    $this->actingAs($admin)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('products.0.category.id', $category->id)
            ->where('products.0.category.name', 'Archived Category')
            ->where('products.0.category.is_deleted', true)
        );
    ...
    $this->actingAs($admin)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('product.category.name', 'Archived Category')
            ->where('product.category.is_deleted', true)
        );
    ...
    $this->actingAs($admin)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('categories.0.name', 'Archived Category (Deleted)')
            ->where('categories.0.is_deleted', true)
        );
});
